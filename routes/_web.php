...
Route::get('/dashboard', function (Request $request) {
    ...
    if ($filter == 'yesterday') {
        $invoices = Invoice::whereDate('invoice_date', $yesterday)->where('deleted', 0)->orderBy('created_at', 'desc')->paginate(5);
        // echo $invoices;
        ...
        $invoices = Invoice::whereDate('invoice_date', $today)->where('deleted', 0)->orderBy('created_at', 'desc')->paginate(5);
    }
